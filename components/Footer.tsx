    ...
    <footer>
      <div className="wrap">
          ...
          <div className="footer-links">
            ...
            <div>
              ...
              <div className="social-icons">
                ...
                <a href="https://github.com/Comet-Foundry" target="_blank" rel="noopener" aria-label="Comet Foundry on GitHub">
        ...
        <div className="footer-bottom">
          ...
          <span className="mono fb-right">EST. 2026 / UT DALLAS</span>
        </div>
      </div>
    </footer>
  );
