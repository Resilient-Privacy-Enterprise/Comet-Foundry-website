        ...
        <div className="campus-inner">
          <div className="campus-stage">
            <div className="campus-map" aria-hidden="true">
              ...
              <img className="campus-map-svg" src="/assets/campus-map.svg?v=2" alt="Map of the continental United States with Comet Foundry chapter locations" width={950} height={580} loading="lazy" />
            </div>
